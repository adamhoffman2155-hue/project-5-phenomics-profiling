...
_GENE_POOL: List[str] = [
    ...
    "PTEN", "MYC", "AKT1", "MTOR", "CDK4", "CDK6", "RB1", "ATM",
    "ATR", "CHEK1", "CHEK2", "MDM2", "CDKN2A", "BCL2", "BAX",
    "CASP3", "CASP8", "CASP9", "JAK2", "STAT3", "NFKB1", "TNF",
    "IL6", "HIF1A", "VEGFA", "ERBB2", "FGFR1", "MET", "ALK",
    "ROS1", "NTRK1", "MAP2K1", "MAPK1", "RAF1", "SRC", "ABL1",
    "FLT3", "KIT", "PDGFRA", "RET", "SMO", "NOTCH1", "WNT1",
    "CTNNB1", "APC", "SMAD4", "TGFBR1", "HDAC1", "HDAC2", "EZH2",
    "DNMT1", "BRD4", "CREBBP", "EP300", "KDM5A", "IDH1", "IDH2",
    "SDHB", "FH", "VHL", "NF1", "NF2", "TSC1", "TSC2",
    "STK11", "FBXW7", "ARID1A", "SMARCA4", "BAP1", "POLE", "MSH2",
    "MLH1", "MSH6", "PMS2", "RAD51", "PALB2", "FANCA", "FANCD2",
    "BLM", "WRN", "RECQL4", "XRCC1", "ERCC1", "XPA",
]
...
def generate_synthetic_data(
    ...
    well_ids = [f"{r}{c:02d}" for r, c in zip(well_rows, well_cols)]
